...
class ResolveCommand extends Command
{
    ...
    public function configure(): void
    {
        ...
        $this->addArgument(self::SEASON, InputArgument::OPTIONAL, 'Season', 2020);
    }
    ...
    private function getPuzzleSolutionClass(InputInterface $input): string
    {
        ...
        return sprintf('AdventOfCode\\Season%d\\Day%d\\PuzzleSolution%sPart', $season, $day, Strings::firstUpper($part));
    }
}
